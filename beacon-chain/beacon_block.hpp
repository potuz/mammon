...
public:
  ...
  constexpr ListFixedSizedParts<ProposerSlashing> const &
  proposer_slashings() const {
    return proposer_slashings_;
  }
  constexpr ListVariableSizedParts<AttesterSlashing> const &
  attester_slashings() const {
  ...
  constexpr ListFixedSizedParts<SignedVoluntaryExit> const &
  voluntary_exits() const {
