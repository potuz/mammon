...
int main(int argc, char *argv[]) {
  ...
  std::filesystem::path path =
      "/home/heluani/Documents/code/eth2.0-spec-tests/tests/minimal/phase0/"
      "ssz_static/Checkpoint/ssz_random/case_0/serialized.ssz_snappy";
