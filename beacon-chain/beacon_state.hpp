...
private:
  ...
  VectorFixedSizedParts<Root, constants::SLOTS_PER_HISTORICAL_ROOT>
      block_roots_, state_roots_;
  ...
  VectorFixedSizedParts<Bytes32, constants::EPOCHS_PER_HISTORICAL_VECTOR>
      randao_mixes_;
  VectorFixedSizedParts<Gwei, constants::EPOCHS_PER_SLASHINGS_VECTOR>
      slashings_;
  ListVariableSizedParts<PendingAttestation> previous_epoch_attestations_,
      current_epoch_attestations_;
  Bitvector<constants::JUSTIFICATION_BITS_LENGTH> justification_bits_;
  Checkpoint previous_justified_checkpoint_, current_justified_checkpoint_,
